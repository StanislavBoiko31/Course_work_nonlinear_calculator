...
{
    public partial class FirstSystemForm : Form
    {
        private SecondSystemForm form2;
        public FirstSystemForm()
        {
            InitializeComponent();
            ...
            form2 = new SecondSystemForm();
            comboBox1.SelectedIndexChanged += comboBox1_SelectedIndexChanged;
        }
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            // Відкриваємо другу форму, якщо користувач змінив індекс у випадаючому списку
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                // Створюємо першу систему рівнянь
                Equation1 my_equation = new Equation1(my_coefficients, approximation, new_accuracy);

                double[] result = new double[4]; // Змінна для зберігання результату
                ...
                {
                    ResultForm form3 = new ResultForm(result, my_coefficients, "first", accuracy); // Виводимо результат у новій формі
                    form3.ShowDialog();
                }
            }
            catch(Exception ex)
